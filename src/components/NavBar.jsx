...
const WIZARD_TABS = [
  ...
  { key: 'acid-fast', label: 'Acid-Fast (AFB)', available: false },
  { key: 'anaerobes', label: 'Anaerobes', available: false },
];
    ...
    <header className="navbar">
      ...
      <div className="navbar-top">
        ...
        <div className="navbar-actions">
          ...
          <button className="export-btn" onClick={onExport} aria-label="Export chart as PNG">
      ...
      <nav className="navbar-tabs-bar" aria-label="Identification flowcharts">
        <div className="navbar-tabs">
          {WIZARD_TABS.map((w) => (
            ...
            >
              {w.label}
              {!w.available && <span className="tab-soon" aria-hidden="true">soon</span>}
            </button>
          ))}
        </div>
      </nav>
