...
// Full node map (id → node) for O(1) lookup
export const nodes = {
  root: gramPositiveTree,
...
// Returns { min, max } number of decision steps remaining from a given node
// to any result node. Memoized at module level.
const _stepsCache = {};
